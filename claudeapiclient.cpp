...
// Используем OpenRouter, так как ваш ключ sk-or-v1-... является ключом OpenRouter.
// При желании можно заменить на прямой DeepSeek API (см. комментарий).
...
// Альтернативный прямой DeepSeek API (закомментировано):
// static const char* DEEPSEEK_API_KEY = "sk-...";
// static const char* DEEPSEEK_MODEL   = "deepseek-chat";
// static const char* DEEPSEEK_URL     = "https://api.deepseek.com/v1/chat/completions";
// ---------------------------------------------------------------------
...
// ---- System prompt (тот же, что и для Groq) --------------------------
